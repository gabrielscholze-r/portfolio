...
export default function Skills() {
    const skills = [
        ...
        { icon: "devicon-docker-plain-wordmark",         title: "Docker",      exp: 70, list: ["Used in personal projects"] },
        { icon: "devicon-spring-original",               title: "Spring Boot", exp: 50, list: ["Projects during university"] },
        { icon: "devicon-reactnative-original",          title: "React Native",exp: 50, list: ["Mobile development in personal projects"] },
