    ...
    return (
        <div className={`portfolio-modal ${info ? 'open' : ''}`}>
            ...
            <div className='info-content'>
                ...
                <div className="sector-portfolio2 my-3">Para mais informações sobre projeto, acese o github abaixo</div>
                <a className='project-link-info my-3' href="" target='_blank'>
